...
class _ResponsiveGridState extends State<ResponsiveGrid> {
  ...
  void _updateScroll(DragUpdateDetails details) {
    final delta = details.globalPosition.dx - _startDragX; // Calculate the change in X
    _scrollController.jumpTo(_scrollController.offset - delta); // Update the scroll position
